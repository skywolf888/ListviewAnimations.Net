...
{
    public abstract class BaseAdapterDecorator : BaseAdapter, ISectionIndexer, ISwappable, IInsertable, IListViewWrapperSetter
    {
        ...
        {
            if (mDecoratedBaseAdapter is ISwappable)
            {
                ((ISwappable)mDecoratedBaseAdapter).swapItems(positionOne, positionTwo);
            }
            else
            {
        ...
        {
            if (mDecoratedBaseAdapter is IInsertable)
            {
                //noinspection rawtypes
                ((IInsertable)mDecoratedBaseAdapter).add(index, item);
            }
            else
            {
